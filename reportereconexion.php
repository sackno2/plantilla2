...
<table class="table table-bordered" border="1" align="center" cellpadding="1" >
            <thead>
              <tr>
                <th class="text-center" style="width: 2%;">#</th>
                <th class="text-center" style="width: 5%;"> Cuenta </th>
                <th class="text-center" style="width: 8%;"> Nombre</th>
                <th class="text-center" style="width: 8%;"> Apellido</th>
                <th class="text-center" style="width: 10%;"> Fech. Orden</th>
                <th class="text-center" style="width:  5%;"> Ejecutada</th>
