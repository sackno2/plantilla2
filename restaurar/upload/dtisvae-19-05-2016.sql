...
INSERT INTO `estudiante` VALUES (4,'0000000234','GARFIELL','SOTO','CENTRO ESCOLAR COLONIA CARRILLO','13021','U',15,'M','7','A','BARRIO LA VEGA','2016-05-19'),(5,'0000007785','SAMUEL ','CAÑAS','CENTRO ESCOLAR COLONIA CARRILLO','13021','U',16,'M','7','A','COLONIA BELEN, SAN MIGUEL','2016-05-19');
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `form1` (
  `id1` int(6) NOT NULL AUTO_INCREMENT,
  `id_f1` varchar(10) COLLATE utf8_spanish_ci NOT NULL,
...
INSERT INTO `form1` VALUES (3,'0000000234','GARFIELL','SOTO','13021','7','A','M',15,'2016-05-19',2,2,1,1,2,1,2,1,2,2,2,1,1,2,2,2,1,1,2,2,1,2,0,2,2,1,1,41,16,13,12,'ALTA','MEDIA','MEDIA',3,2,2),(4,'0000007785','SAMUEL ','CAÑAS','13021','7','A','M',16,'2016-05-19',1,1,2,1,1,2,1,1,2,1,2,2,1,2,1,2,1,1,1,1,2,1,0,1,2,2,2,37,11,11,15,'MEDIA','MEDIA','ALTA',2,2,3);
...
INSERT INTO `form10` VALUES ('0000007785','SAMUEL ','CAÑAS;','13021;','7','A','M',16,'2016-05-19',2,1,1,1,1,1,2,1,1,1,1,2,2,1,2,1,1,2,1,1,2,2,1,1,1,2,2,2,2,2,43,15,13,15,'MEDIA',2,'MEDIA',2,'MEDIA',2,'FALSO','FALSO','FALSO');
...
/*!50001 CREATE TABLE `form10_7pdf` (
  `id_f10` tinyint NOT NULL,
  `nombreestF10` tinyint NOT NULL,
  `apellidoestF10` tinyint NOT NULL,
  `gradoF10` tinyint NOT NULL,
  `seccionF10` tinyint NOT NULL,
  `edadF10` tinyint NOT NULL,
  `N_implicacionF10` tinyint NOT NULL,
  `N_afilalumnosF10` tinyint NOT NULL,
  `N_ayudaprofesorF10` tinyint NOT NULL,
  `B_implicacionF10` tinyint NOT NULL,
  `B_afiliacionF10` tinyint NOT NULL,
  `B_ayudaF10` tinyint NOT NULL
) ENGINE=MyISAM */;
...
/*!50001 CREATE TABLE `form10_va` (
  `nombreestF10` tinyint NOT NULL,
  `apellidoestF10` tinyint NOT NULL,
  `codigoescF10` tinyint NOT NULL,
  `gradoF10` tinyint NOT NULL,
  `seccionF10` tinyint NOT NULL,
  `sexoF10` tinyint NOT NULL,
  `edadF10` tinyint NOT NULL,
  `fechaentrevistaF10` tinyint NOT NULL,
  `puntajeF10` tinyint NOT NULL,
  `P_implicacionF10` tinyint NOT NULL,
  `P_afilalumnosF10` tinyint NOT NULL,
  `P_ayudaprofesorF10` tinyint NOT NULL,
  `N_implicacionF10` tinyint NOT NULL,
  `N_afilalumnosF10` tinyint NOT NULL,
  `N_ayudaprofesorF10` tinyint NOT NULL,
  `B_implicacionF10` tinyint NOT NULL,
...
INSERT INTO `form11` VALUES ('0000000234','GARFIELL','SOTO','13021','7','A','M',15,'2016-05-19',2,0,0,7,'',0,'EVENTUAL',2,0,10,'',0,'EVENTUAL',2,0,9,'',0,'EVENTUAL',2,0,8,'',0,'EVENTUAL',2,0,7,'',0,'EVENTUAL',2,'',0,'EVENTUAL',2,'',0,'EVENTUAL',2,'',0,'EVENTUAL',2,'',0,'EVENTUAL',2,'',0,'EVENTUAL',2),('0000007785','SAMUEL ','CAÑAS','13021','7','A','M',16,'2016-05-19',0,1,8,0,'EVENTUAL',2,'',0,13,0,'RECURRENTE',3,'',0,13,0,'RECURRENTE',3,'',0,9,0,'EVENTUAL',2,'',0,10,0,'RECURRENTE',3,'',0,'EVENTUAL',2,'',0,'RECURRENTE',3,'',0,'RECURRENTE',3,'',0,'EVENTUAL',2,'',0,'RECURRENTE',3,'',0);
...
/*!50001 CREATE TABLE `form11_7pdf` (
  `id_f11` tinyint NOT NULL,
  `nombreestF11` tinyint NOT NULL,
  `apellidoestF11` tinyint NOT NULL,
  `gradoF11` tinyint NOT NULL,
  `seccionF11` tinyint NOT NULL,
  `edadF11` tinyint NOT NULL,
  `N_tacticaspadres1B` tinyint NOT NULL,
  `N_tacticaspadres2B` tinyint NOT NULL,
  `N_tacticaspadres3B` tinyint NOT NULL,
  `N_tacticaspadres4B` tinyint NOT NULL,
  `N_tacticaspadres5B` tinyint NOT NULL,
  `N_tacticaspadres6B` tinyint NOT NULL,
  `N_tacticaspadres7B` tinyint NOT NULL,
  `N_tacticaspadres8B` tinyint NOT NULL,
  `N_tacticaspadres9B` tinyint NOT NULL,
  `N_tacticaspadres10B` tinyint NOT NULL,
  `N_tacticaspadres1BB` tinyint NOT NULL,
  `N_tacticaspadres2BB` tinyint NOT NULL,
  `N_tacticaspadres3BB` tinyint NOT NULL,
  `N_tacticaspadres4BB` tinyint NOT NULL,
  `N_tacticaspadres5BB` tinyint NOT NULL,
  `N_tacticaspadres6BB` tinyint NOT NULL,
  `N_tacticaspadres7BB` tinyint NOT NULL,
  `N_tacticaspadres8BB` tinyint NOT NULL,
  `N_tacticaspadres9BB` tinyint NOT NULL,
  `N_tacticaspadres10BB` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
/*!50001 CREATE TABLE `form11_va` (
  `nombreestF11` tinyint NOT NULL,
  `apellidoestF11` tinyint NOT NULL,
  `codigoescF11` tinyint NOT NULL,
  `gradoF11` tinyint NOT NULL,
  `seccionF11` tinyint NOT NULL,
  `sexoF11` tinyint NOT NULL,
  `edadF11` tinyint NOT NULL,
  `fechaentrevistaF11` tinyint NOT NULL,
  `F_paterna` tinyint NOT NULL,
  `F_materna` tinyint NOT NULL,
  `P_tacticaspadres1` tinyint NOT NULL,
  `P_tacticaspadres2` tinyint NOT NULL,
  `N_tacticaspadres1B` tinyint NOT NULL,
  `N_tacticaspadres2B` tinyint NOT NULL,
  `P_tacticaspadres3` tinyint NOT NULL,
  `P_tacticaspadres4` tinyint NOT NULL,
  `N_tacticaspadres3B` tinyint NOT NULL,
  `N_tacticaspadres4B` tinyint NOT NULL,
  `P_tacticaspadres5` tinyint NOT NULL,
  `P_tacticaspadres6` tinyint NOT NULL,
  `N_tacticaspadres5B` tinyint NOT NULL,
  `N_tacticaspadres6B` tinyint NOT NULL,
  `P_tacticaspadres7` tinyint NOT NULL,
  `P_tacticaspadres8` tinyint NOT NULL,
  `N_tacticaspadres7B` tinyint NOT NULL,
  `N_tacticaspadres8B` tinyint NOT NULL,
  `P_tacticaspadres9` tinyint NOT NULL,
  `P_tacticaspadres10` tinyint NOT NULL,
  `N_tacticaspadres9B` tinyint NOT NULL,
  `N_tacticaspadres10B` tinyint NOT NULL,
  `N_tacticaspadres1BB` tinyint NOT NULL,
  `N_tacticaspadres2BB` tinyint NOT NULL,
...
/*!50001 CREATE TABLE `form1_7pdf` (
  `id_f1` tinyint NOT NULL,
  `nombreestF1` tinyint NOT NULL,
  `apellidoestF1` tinyint NOT NULL,
  `gradoF1` tinyint NOT NULL,
  `seccionF1` tinyint NOT NULL,
  `edadF1` tinyint NOT NULL,
  `nivel_coheF1` tinyint NOT NULL,
  `nivel_expresiF1` tinyint NOT NULL,
  `nivel_conflicF1` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
/*!50001 CREATE TABLE `form1_v7` (
  ...
  `nombreestF1` tinyint NOT NULL,
  `apellidoestF1` tinyint NOT NULL,
  `codigoescF1` tinyint NOT NULL,
  `gradoF1` tinyint NOT NULL,
  `seccionF1` tinyint NOT NULL,
  `sexoF1` tinyint NOT NULL,
  `edadF1` tinyint NOT NULL,
  `fechaentrevistaF1` tinyint NOT NULL,
  `item1F1` tinyint NOT NULL,
  `item2F1` tinyint NOT NULL,
  `item3F1` tinyint NOT NULL,
  `item4F1` tinyint NOT NULL,
  `item5F1` tinyint NOT NULL,
  `item6F1` tinyint NOT NULL,
  `item7F1` tinyint NOT NULL,
  `item8F1` tinyint NOT NULL,
  `item9F1` tinyint NOT NULL,
  `item10F1` tinyint NOT NULL,
  `item11F1` tinyint NOT NULL,
  `item12F1` tinyint NOT NULL,
  `item13F1` tinyint NOT NULL,
  `item14F1` tinyint NOT NULL,
  `item15F1` tinyint NOT NULL,
  `item16F1` tinyint NOT NULL,
  `item17F1` tinyint NOT NULL,
  `item18F1` tinyint NOT NULL,
  `item19F1` tinyint NOT NULL,
  `item20F1` tinyint NOT NULL,
  `item21F1` tinyint NOT NULL,
  `item22F1` tinyint NOT NULL,
  `item23F1` tinyint NOT NULL,
  `item24F1` tinyint NOT NULL,
  `item25F1` tinyint NOT NULL,
  `item26F1` tinyint NOT NULL,
  `item27F1` tinyint NOT NULL,
  `puntajeF1` tinyint NOT NULL,
  `cohesionF1` tinyint NOT NULL,
  `expresividadF1` tinyint NOT NULL,
  `conflictoF1` tinyint NOT NULL,
  `nivel_coheF1` tinyint NOT NULL,
  `nivel_expresiF1` tinyint NOT NULL,
  `nivel_conflicF1` tinyint NOT NULL,
  `codigo_coheF1` tinyint NOT NULL,
  `codigo_expresiF1` tinyint NOT NULL,
  `codigo_conflicF1` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
INSERT INTO `form2` VALUES ('0000000234','GARFIELL','SOTO','13021','7','A','M',15,'2016-05-19',1,2,2,3,3,3,3,3,3,3,15,6,5,'MEDIA','BAJA','BAJA',2,1,1,31,'MEDIA',2),('0000007785','SAMUEL ','CAÑAS','13021','7','A','M',16,'2016-05-19',5,5,6,6,4,2,1,3,4,4,14,14,12,'MEDIA','MEDIA','ALTA',2,2,3,47,'ALTA',3);
...
/*!50001 CREATE TABLE `form2_7pdf` (
  `id_f2` tinyint NOT NULL,
  `nombreestF2` tinyint NOT NULL,
  `apellidoestF2` tinyint NOT NULL,
  `gradoF2` tinyint NOT NULL,
  `seccionF2` tinyint NOT NULL,
  `edadF2` tinyint NOT NULL,
  `N_prointeescF2` tinyint NOT NULL,
  `N_rendiescF2` tinyint NOT NULL,
  `N_expacademicaF2` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
INSERT INTO `form3` VALUES ('0000000234','GARFIELL','SOTO','13021','7','A','M',15,'2016-05-19',1,2,3,3,3,3,3,2,2,2,2,3,3,3,2,2,2,2,2,3,1,1,8,16,24,1,1,'POCO FRECUENTE',2,'MUY FRECUENTE',3,'POCO FRECUENTE',2,'INDIVIDUAL',1,'NINGUNO',0,'NINGUNO',0,'NINGUNO',1,0),('0000007785','SAMUEL ','CAÑAS','13021','7','A','M',16,'2016-05-19',1,3,3,4,3,3,3,3,4,4,4,3,4,4,4,4,3,4,4,4,1,1,13,22,34,1,1,'MUY FRECUENTE',3,'MUY FRECUENTE',3,'MUY FRECUENTE',3,'INDIVIDUAL',1,'NINGUNO',0,'NINGUNO',0,'NINGUNO',1,0);
...
/*!50001 CREATE TABLE `form3_7pdf` (
  `id_f3` tinyint NOT NULL,
  `nombreestF3` tinyint NOT NULL,
  `apellidoestF3` tinyint NOT NULL,
  `gradoF3` tinyint NOT NULL,
  `seccionF3` tinyint NOT NULL,
  `edadF3` tinyint NOT NULL,
  `N_manifisicaF3` tinyint NOT NULL,
  `N_maniverbalF3` tinyint NOT NULL,
  `N_relacionalF3` tinyint NOT NULL,
  `S_victimizadorHF3` tinyint NOT NULL,
  `S_victimizadorMF3` tinyint NOT NULL,
  `S_victimizadorCF3` tinyint NOT NULL,
  `N_frecuenciaF3` tinyint NOT NULL,
  `sospechaF3` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
/*!50001 CREATE TABLE `form3_va` (
  `nombreestF3` tinyint NOT NULL,
  `apellidoestF3` tinyint NOT NULL,
  `codigoescF3` tinyint NOT NULL,
  `gradoF3` tinyint NOT NULL,
  `seccionF3` tinyint NOT NULL,
  `sexoF3` tinyint NOT NULL,
  `edadF3` tinyint NOT NULL,
  `fechaentrevistaF3` tinyint NOT NULL,
  `P_manifisicaF3` tinyint NOT NULL,
  `P_maniverbalF3` tinyint NOT NULL,
  `P_vicrelacionalF3` tinyint NOT NULL,
  `P_item21F3` tinyint NOT NULL,
  `P_item22F3` tinyint NOT NULL,
  `N_manifisicaF3` tinyint NOT NULL,
  `N_maniverbalF3` tinyint NOT NULL,
  `N_relacionalF3` tinyint NOT NULL,
  `S_victimizadorHF3` tinyint NOT NULL,
  ...
  `S_victimizadorCF3` tinyint NOT NULL,
  `N_frecuenciaF3` tinyint NOT NULL,
  `C_frecuenciaF3` tinyint NOT NULL,
  `sospechaF3` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
INSERT INTO `form4` VALUES ('0000000234','GARFIELL','SOTO','13021','7','A','M',15,'2016-05-19',1,2,2,2,2,3,3,4,4,10,13,'MEDIA',2,'ALTA',3),('0000007785','SAMUEL ','CAÑAS','13021','7','A','M',16,'2016-05-19',2,3,3,4,4,4,3,4,4,17,14,'ALTA',3,'ALTA',3);
...
/*!50001 CREATE TABLE `form4_7pdf` (
  `id_f4` tinyint NOT NULL,
  `nombreestF4` tinyint NOT NULL,
  `apellidoestF4` tinyint NOT NULL,
  `gradoF4` tinyint NOT NULL,
  `seccionF4` tinyint NOT NULL,
  `edadF4` tinyint NOT NULL,
  `N_positivaautoInsF4` tinyint NOT NULL,
  `N_positivatransnormasF4` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
/*!50001 CREATE TABLE `form4_va` (
  `nombreestF4` tinyint NOT NULL,
  `apellidoestF4` tinyint NOT NULL,
  `codigoescF4` tinyint NOT NULL,
  `gradoF4` tinyint NOT NULL,
  `seccionF4` tinyint NOT NULL,
  `sexoF4` tinyint NOT NULL,
  `edadF4` tinyint NOT NULL,
  `fechaentrevistaF4` tinyint NOT NULL,
  `P_positivaautoF4` tinyint NOT NULL,
  `P_positivatransF4` tinyint NOT NULL,
  `N_positivaautoInsF4` tinyint NOT NULL,
  `N_positivatransnormasF4` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
INSERT INTO `form6` VALUES ('0000000234','GARFIELL','SOTO','13021','7','A','M',15,'2016-05-19',1,2,3,3,2,3,3,3,3,2,1,2,3,3,3,3,2,3,3,3,3,3,2,3,3,10,10,15,11,8,11,'POCO FRECUENTE',2,'POCO FRECUENTE',2,'MUY FRECUENTE',3,'MUY FRECUENTE',3,'POCO FRECUENTE',2,'MUY FRECUENTE',3),('0000007785','SAMUEL ','CAÑAS','13021','7','A','M',16,'2016-05-19',3,3,4,4,4,4,3,4,4,4,4,4,3,4,4,4,3,4,4,4,4,4,4,4,3,13,16,19,16,14,16,'MUY FRECUENTE',3,'MUY FRECUENTE',3,'MUY FRECUENTE',3,'MUY FRECUENTE',3,'MUY FRECUENTE',3,'MUY FRECUENTE',3);
...
/*!50001 CREATE TABLE `form6_7pdf` (
  `id_f6` tinyint NOT NULL,
  `nombreestF6` tinyint NOT NULL,
  `apellidoestF6` tinyint NOT NULL,
  `gradoF6` tinyint NOT NULL,
  `seccionF6` tinyint NOT NULL,
  `edadF6` tinyint NOT NULL,
  `N_manipuraF6` tinyint NOT NULL,
  `N_manireactivaF6` tinyint NOT NULL,
  `N_maniinstrumentalF6` tinyint NOT NULL,
  `N_relapuraF6` tinyint NOT NULL,
  `N_relareactivaF6` tinyint NOT NULL,
  `N_relainstrumentalF6` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
/*!50001 CREATE TABLE `form6_va` (
  `nombreestF6` tinyint NOT NULL,
  `apellidoestF6` tinyint NOT NULL,
  `codigoescF6` tinyint NOT NULL,
  `gradoF6` tinyint NOT NULL,
  `seccionF6` tinyint NOT NULL,
  `sexoF6` tinyint NOT NULL,
  `edadF6` tinyint NOT NULL,
  `fechaentrevistaF6` tinyint NOT NULL,
  `P_manipuraF6` tinyint NOT NULL,
  `P_manireactivaF6` tinyint NOT NULL,
  `P_maniinstrumentalF6` tinyint NOT NULL,
  `P_relapuraF6` tinyint NOT NULL,
  `P_relareactivaF6` tinyint NOT NULL,
  `P_relainstrumentalF6` tinyint NOT NULL,
  `N_manipuraF6` tinyint NOT NULL,
  `N_manireactivaF6` tinyint NOT NULL,
  `N_maniinstrumentalF6` tinyint NOT NULL,
  `N_relapuraF6` tinyint NOT NULL,
...
INSERT INTO `form7` VALUES ('0000007785','SAMUEL ','CAÑAS','13021','7','A','M',16,'2016-05-19',1,3,3,4,4,3,3,1,19,'MUY FRECUENTE',3);
...
/*!50001 CREATE TABLE `form7_7pdf` (
  `id_f7` tinyint NOT NULL,
  `nombreestF7` tinyint NOT NULL,
  `apellidoestF7` tinyint NOT NULL,
  `gradoF7` tinyint NOT NULL,
  `seccionF7` tinyint NOT NULL,
  `edadF7` tinyint NOT NULL,
  `N_sintomadepreF7` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
/*!50001 CREATE TABLE `form7_va` (
  `nombreestF7` tinyint NOT NULL,
  `apellidoestF7` tinyint NOT NULL,
  `codigoescF7` tinyint NOT NULL,
  `gradoF7` tinyint NOT NULL,
  `seccionF7` tinyint NOT NULL,
  `sexoF7` tinyint NOT NULL,
  `edadF7` tinyint NOT NULL,
  `fechaentrevistaF7` tinyint NOT NULL,
  `descuentoF7` tinyint NOT NULL,
  `P_animodepreF7` tinyint NOT NULL,
  `N_sintomadepreF7` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
INSERT INTO `form8` VALUES ('0000000234','GARFIELL','SOTO;','13021;','7','A','M',15,'2016-05-19',4,3,2,3,3,2,4,3,4,2,30,'EXTREMO MALESTAR',4),('0000007785','SAMUEL ','CAÑAS','13021','7','A','M',16,'2016-05-19',2,3,4,4,4,5,5,5,5,4,41,'EXTREMO MALESTAR',4);
...
/*!50001 CREATE TABLE `form8_7pdf` (
  `id_f8` tinyint NOT NULL,
  `nombreestF8` tinyint NOT NULL,
  `apellidoestF8` tinyint NOT NULL,
  `gradoF8` tinyint NOT NULL,
  `seccionF8` tinyint NOT NULL,
  `edadF8` tinyint NOT NULL,
  `N_malkesslerF8` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
/*!50001 CREATE TABLE `form8_va` (
  `nombreestF8` tinyint NOT NULL,
  `apellidoestF8` tinyint NOT NULL,
  `codigoescF8` tinyint NOT NULL,
  `gradoF8` tinyint NOT NULL,
  `seccionF8` tinyint NOT NULL,
  `sexoF8` tinyint NOT NULL,
  `edadF8` tinyint NOT NULL,
  `fechaentrevistaF8` tinyint NOT NULL,
  `P_malkesslerF8` tinyint NOT NULL,
  `N_malkesslerF8` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
INSERT INTO `form9` VALUES ('0000007785','SAMUEL ','CAÑAS','13021','7','A','M',16,'2016-05-19',2,3,3,3,11,'MUY FRECUENTE',3);
...
/*!50001 CREATE TABLE `form9_7pdf` (
  `id_f9` tinyint NOT NULL,
  `nombreestF9` tinyint NOT NULL,
  `apellidoestF9` tinyint NOT NULL,
  `gradoF9` tinyint NOT NULL,
  `seccionF9` tinyint NOT NULL,
  `edadF9` tinyint NOT NULL,
  `N_ideasuicidaF9` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
/*!50001 CREATE TABLE `form9_va` (
  `nombreestF9` tinyint NOT NULL,
  `apellidoestF9` tinyint NOT NULL,
  `codigoescF9` tinyint NOT NULL,
  `gradoF9` tinyint NOT NULL,
  `seccionF9` tinyint NOT NULL,
  `sexoF9` tinyint NOT NULL,
  `edadF9` tinyint NOT NULL,
  `fechaentrevistaF9` tinyint NOT NULL,
  `P_ideasuicidaF9` tinyint NOT NULL,
  `N_ideasuicidaF9` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
INSERT INTO `institucion` VALUES (1,'13021','U','CENTRO ESCOLAR COLONIA CARRILLO','CDE','SAN MIGUEL','SAN MIGUEL','CALLE PRINCIPAL Y AV JERUSALEN','','','2667-3973',0.99999,-0.99999,0);
...
-- Dump completed on 2016-05-19 14:38:50
