...
<div class="col-md-12">
 ...
 <div class="panel-heading clearfix">
          <strong>
            ...
            <span>Revertir recibo anulado</span>
         </strong>
        </div>
...
<!-- Formulario-->
           ...
           <input type="checkbox" id="solucionado" name="checkbox" value="solucionado" required /><label for="solucionado"><b>Marcar para confirmar</b></label>
            <input type="submit" name="guardar" value="Revertir" class="btn btn-primary"/>&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<table align="center" width="99%" height="80" cellspacing="0" cellpadding="0" style="border: solid 1px #CED8F6;" class="tabla_bordes_color">
						...
						if ( $_REQUEST['guardar'] == "Revertir" )
						{
                                                        ...
                                                        
							{
								...
								$query = "SELECT num_recibo,anulado FROM recibos WHERE num_recibo='$num_recibo' AND anulado='NO' ";
								...
								if($row = mysqli_fetch_array($result_query))
								
									{
										...
										<font color="red">!Recibo <b>'.$num_recibo.'</b> No estaba anulado. No se efectuaron cambios</b>!</font>
										</center>';
									...
									{
										//marca el recibo
										$actualiza="UPDATE recibos SET anulado='NO' WHERE num_recibo='$num_recibo'";
										...
										else
										{
											...
											<font color="green" >!El Recibo <b>'.$num_recibo.'</b> fue Revertido a NO ANULADO</b>!</font><br>
											</center>
											';
									    }
