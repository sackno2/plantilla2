  ...
  */
  ...
  echo '<table Width="100%" cellspacing="0" cellpadding="0"  style="border: solid 1px silver;">';
	...
	echo"
		...
		&nbsp;	<a style=\"cursor:pointer;\" class='btn btn-danger btn-xs'  data-toggle='tooltip' title='Eliminar Linea'  onclick=\"eliminarDato('".$row['cod_servicio']."')\"><span class='glyphicon glyphicon-trash'></span></a>
